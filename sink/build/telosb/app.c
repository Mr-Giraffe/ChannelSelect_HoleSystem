...
static void SinkMethodC__Boot__booted(void );
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void SinkMethodC__SerialControl__startDone(error_t error);
#line 117
static void SinkMethodC__SerialControl__stopDone(error_t error);
#line 92
static void SinkMethodC__RadioControl__startDone(error_t error);
#line 117
static void SinkMethodC__RadioControl__stopDone(error_t error);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void SinkMethodC__UARTSend__sendDone(
#line 92
message_t * msg, 
...
SinkMethodC__RadioReceive__receive(
#line 60
message_t * msg, 
void * payload, 
...
uint8_t len);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void SinkMethodC__RadioSend__sendDone(
#line 92
message_t * msg, 
...
SinkMethodC__UARTReceive__receive(
# 19 "SinkMethodC.nc"
am_id_t arg_0x40620010, 
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 85
message_t * msg, 
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 85
message_t * msg, 
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t SinkMethodC__SerialControl__start(void );
#line 83
static error_t SinkMethodC__RadioControl__start(void );
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t SinkMethodC__UARTSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 50 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void SinkMethodC__Leds__led0Off(void );





static void SinkMethodC__Leds__led0Toggle(void );




static void SinkMethodC__Leds__led1On(void );
...
static void SinkMethodC__Leds__led1Toggle(void );
#line 89
static void SinkMethodC__Leds__led2Toggle(void );
#line 66
static void SinkMethodC__Leds__led1Off(void );
#line 83
static void SinkMethodC__Leds__led2Off(void );
#line 45
static void SinkMethodC__Leds__led0On(void );
#line 78
static void SinkMethodC__Leds__led2On(void );
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t SinkMethodC__RadioSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 29 "SinkMethodC.nc"
enum SinkMethodC____nesc_unnamed4310 {


  SinkMethodC__INITIAL = 10, 
  SinkMethodC__START_DETECT = 11, 
  SinkMethodC__STOP_DETECT = 12, 
  SinkMethodC__DATA_COLLECTION = 13, 

  SinkMethodC__RED = 1, 
  SinkMethodC__GREEN = 2, 
  SinkMethodC__BLUE = 3, 
  SinkMethodC__ON = 0, 
  SinkMethodC__OFF = 1, 
  SinkMethodC__TOGGLE = 2
};



bool SinkMethodC__radioBusy;
bool SinkMethodC__UARTBusy;
...
static void SinkMethodC__ledOp(uint8_t led, uint8_t op);
#line 115
static inline void SinkMethodC__Boot__booted(void );
...
static inline void SinkMethodC__SerialControl__startDone(error_t err);
...
static inline void SinkMethodC__SerialControl__stopDone(error_t err);



static inline void SinkMethodC__RadioControl__startDone(error_t err);
#line 154
static inline void SinkMethodC__RadioControl__stopDone(error_t err);
...
static inline void SinkMethodC__RadioSend__sendDone(message_t *msg, error_t err);




static inline message_t *SinkMethodC__RadioReceive__receive(message_t *msg, void *payload, uint8_t len);
#line 192
static void SinkMethodC__UARTSend__sendDone(message_t *msg, error_t err);
...
static inline message_t *SinkMethodC__UARTReceive__receive(am_id_t id, message_t *msg, void *payload, uint8_t len);
# 51 "/opt/tinyos-2.1.1/tos/interfaces/Init.nc"
...
message_t *msg);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 56
message_t * msg, 
...
static void /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 147
message_t * amsg, 
...
static inline error_t /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 56
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static void /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
static inline error_t /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
#line 161
enum /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1____nesc_unnamed4377 {
#line 161
...
#line 49
#line 47
typedef struct /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1____nesc_unnamed4378 {
  message_t * msg;
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x406ec088){
#line 28
  switch (arg_0x406ec088) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x406ec088);
#line 28
      break;
#line 28
    }
...
# 88 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x40fde4b8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x40fde4b8, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40bc7d90){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  switch (arg_0x40bc7d90) {
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40bc7d90);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40bc67f8){
#line 39
  union __nesc_unnamed4283 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40bc67f8);
#line 39
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40ca4a58){
#line 49
  switch (arg_0x40ca4a58) {
#line 49
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40ca4a58);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40ca5690){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40ca5690);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40bc7d90){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40bc7d90);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x40ca5690){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x40ca5690);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40bc7d90){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40bc7d90);
#line 78
      break;
#line 78
    }
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40ca4a58){
#line 55
  switch (arg_0x40ca4a58) {
#line 55
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40ca4a58);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40bc7d90){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40bc7d90);
#line 110
      break;
#line 110
    }
...
#line 54
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  SinkMethodC__UARTSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__sendDone(uint8_t arg_0x41057088, message_t * msg, error_t error){
#line 89
  switch (arg_0x41057088) {
#line 89
    case 0U:
#line 89
      /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__Send__default__sendDone(arg_0x41057088, msg, error);
#line 89
      break;
#line 89
    }
...
inline static void SinkMethodC__Leds__led0On(void ){
#line 45
  LedsP__Leds__led0On();
#line 45
}
...
# 50 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void SinkMethodC__Leds__led0Off(void ){
#line 50
...
inline static void SinkMethodC__Leds__led0Toggle(void ){
#line 56
...
inline static void SinkMethodC__Leds__led1On(void ){
#line 61
  LedsP__Leds__led1On();
#line 61
}
...
inline static void SinkMethodC__Leds__led1Off(void ){
#line 66
...
inline static void SinkMethodC__Leds__led1Toggle(void ){
#line 72
...
inline static void SinkMethodC__Leds__led2On(void ){
#line 78
  LedsP__Leds__led2On();
#line 78
}
...
inline static void SinkMethodC__Leds__led2Off(void ){
#line 83
...
inline static void SinkMethodC__Leds__led2Toggle(void ){
#line 89
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x41057a70, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x41057a70, addr, msg, len);
#line 69
...
# 23 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x41147b10, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x41147b10) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x41147b10, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x41147b10){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x41147b10);
#line 15
      break;
#line 15
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x4119c388){
#line 92
  switch (arg_0x4119c388) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x4119c388);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x40ca6bd0){
#line 92
  switch (arg_0x40ca6bd0) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x40ca6bd0);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x40ca4a58){
#line 49
  switch (arg_0x40ca4a58) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x40ca4a58);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x41198420){
#line 39
  union __nesc_unnamed4287 *__nesc_result;
#line 39

#line 39
  switch (arg_0x41198420) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x41198420);
#line 39
      break;
#line 39
    }
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x4108ee68, message_t * msg, error_t error){
#line 99
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x4108ee68, msg, error);
#line 99
}
#line 99
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x41147010, message_t * msg, error_t error){
#line 89
  switch (arg_0x41147010) {
#line 89
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x41147010, msg, error);
#line 89
      break;
#line 89
    }
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x41057a70, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x41057a70, addr, msg, len);
#line 69
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 7);
  return /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}

# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t SinkMethodC__RadioSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 69
...
#line 202
  ...
  if (TOS_NODE_ID == SINK_ID) 
    {
      if (SinkMethodC__RadioSend__send(AM_BROADCAST_ADDR, msg, sizeof(CommandMsg )) == SUCCESS) 
        {
          SinkMethodC__radioBusy = TRUE;
          SinkMethodC__ledOp(SinkMethodC__BLUE, SinkMethodC__OFF);
          SinkMethodC__ledOp(SinkMethodC__RED, SinkMethodC__OFF);
          SinkMethodC__ledOp(SinkMethodC__GREEN, SinkMethodC__TOGGLE);
        }
    }
  return msg;
}
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x4108b8e0, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  __nesc_result = SinkMethodC__UARTReceive__receive(arg_0x4108b8e0, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x4114b918, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x4114b918) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x4114b918, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x41147b10, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x41147b10, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x40fdfe20, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x40fdfe20, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x40fde4b8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x40fde4b8, msg);
#line 95
}
#line 95
...
#line 117
  SinkMethodC__SerialControl__stopDone(error);
#line 117
}
#line 117
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x40ca4a58){
#line 55
  switch (arg_0x40ca4a58) {
#line 55
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x40ca4a58);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x41199940){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x41199940) {
#line 110
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x41199940);
#line 110
      break;
#line 110
    }
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x41199940){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x41199940);
#line 118
      break;
#line 118
    }
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t SinkMethodC__RadioControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t SinkMethodC__SerialControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
{
  if (err != SUCCESS) {
    SinkMethodC__SerialControl__start();
    }
  else {
      SinkMethodC__RadioControl__start();
    }
}
...
#line 92
  SinkMethodC__SerialControl__startDone(error);
#line 92
}
#line 92
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x40ca5690){
#line 51
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x40ca5690);
#line 51
}
#line 51
# 90 "/opt/tinyos-2.1.1/tos/system/ArbiterP.nc"
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x41199940){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x41199940);
#line 87
      break;
#line 87
    }
...
static inline void SinkMethodC__RadioSend__sendDone(message_t *msg, error_t err)
{
  SinkMethodC__radioBusy = FALSE;
}

# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  SinkMethodC__RadioSend__sendDone(msg, error);
#line 99
}
#line 99
# 57 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
...
#line 57
{
  /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x41057088, message_t * msg, error_t error){
#line 89
  switch (arg_0x41057088) {
#line 89
    case 0U:
#line 89
      /*SinkMethodAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x41057088, msg, error);
#line 89
      break;
#line 89
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x40f81628){
#line 92
  switch (arg_0x40f81628) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x40f81628);
#line 92
      break;
#line 92
    }
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40f10030){
#line 72
    /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40f10030);
#line 72
}
#line 72
# 56 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x40fe0490, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x40fe0490, msg, payload, len);
#line 67
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
# 151 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 8);
  return /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}

# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t SinkMethodC__UARTSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*SinkMethodAppC.SerialAMSenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 69
...
#line 171
  ...
  if (len == sizeof(LocateMsg )) {
      SinkMethodC__ledOp(SinkMethodC__BLUE, SinkMethodC__OFF);
      SinkMethodC__ledOp(SinkMethodC__GREEN, SinkMethodC__OFF);
      SinkMethodC__ledOp(SinkMethodC__RED, SinkMethodC__TOGGLE);
      if (SinkMethodC__UARTSend__send(AM_BROADCAST_ADDR, msg, sizeof(LocateMsg )) == SUCCESS) 
        {
          SinkMethodC__UARTBusy = TRUE;
          SinkMethodC__ledOp(SinkMethodC__BLUE, SinkMethodC__TOGGLE);
        }
    }
  return msg;
}
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x40fe1db8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40fe1db8) {
#line 67
    case 7:
#line 67
      __nesc_result = SinkMethodC__RadioReceive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x40fe1db8, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40bc8030){
#line 92
  switch (arg_0x40bc8030) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40bc8030);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40ca6bd0){
#line 92
  switch (arg_0x40ca6bd0) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40ca6bd0);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.1.1/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40bc7598, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40bc7598) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40bc7598, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x40b45828, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40b45828) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x40b45828, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x40fde4b8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x40fde4b8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x40b45828, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40b45828) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x40b45828, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x40b22db0){
#line 92
  switch (arg_0x40b22db0) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x40b22db0);
#line 92
      break;
#line 92
    }
...
#line 89
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x40fe13f8, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x40fe13f8, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
#line 117
  SinkMethodC__RadioControl__stopDone(error);
#line 117
}
#line 117
...
static inline void SinkMethodC__RadioControl__startDone(error_t err)
{
  if (err != SUCCESS) {
    SinkMethodC__RadioControl__start();
      ...
      if (TOS_NODE_ID == SINK_ID) 
        {
          SinkMethodC__ledOp(SinkMethodC__BLUE, SinkMethodC__ON);
        }
      else 
        {
          SinkMethodC__ledOp(SinkMethodC__RED, SinkMethodC__ON);
        }
    }
}
...
#line 92
  SinkMethodC__RadioControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40c9e3d0, uint8_t data){
#line 54
  switch (arg_0x40c9e3d0) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40c9e3d0, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x40c9ec50){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x40c9ec50);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40c9e3d0){
#line 49
  switch (arg_0x40c9e3d0) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40c9e3d0);
#line 49
      break;
#line 49
    }
...
# 79 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x4119b558, uint8_t byte){
#line 79
  switch (arg_0x4119b558) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x4119b558, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x4119b558, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x4119b558) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x4119b558, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x40c9e3d0, uint8_t data){
#line 54
  switch (arg_0x40c9e3d0) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x40c9e3d0, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x4119b558, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x4119b558) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x4119b558, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 49 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x40c9e3d0){
#line 49
  switch (arg_0x40c9e3d0) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x40c9e3d0);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x406ec088){
#line 28
  switch (arg_0x406ec088) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x406ec088);
#line 28
      break;
#line 28
    }
...
static void SinkMethodC__ledOp(uint8_t led, uint8_t op)
{
  ...
  if (led == SinkMethodC__RED) 
    {
      if (op == SinkMethodC__ON) 
        {
          SinkMethodC__Leds__led0On();
        }
      else {
#line 66
        if (op == SinkMethodC__OFF) 
          {
            SinkMethodC__Leds__led0Off();
          }
        else {
#line 70
          if (op == SinkMethodC__TOGGLE) 
            {
              SinkMethodC__Leds__led0Toggle();
            }
          }
        }
    }
...
#line 76
    if (led == SinkMethodC__GREEN) 
      {
        if (op == SinkMethodC__ON) 
          {
            SinkMethodC__Leds__led1On();
          }
        else {
#line 82
          if (op == SinkMethodC__OFF) 
            {
              SinkMethodC__Leds__led1Off();
            }
          else {
#line 86
            if (op == SinkMethodC__TOGGLE) 
              {
                SinkMethodC__Leds__led1Toggle();
              }
            }
          }
      }
...
#line 92
      if (led == SinkMethodC__BLUE) 
        {
          if (op == SinkMethodC__ON) 
            {
              SinkMethodC__Leds__led2On();
            }
          else {
#line 98
            if (op == SinkMethodC__OFF) 
              {
                SinkMethodC__Leds__led2Off();
              }
            else {
#line 102
              if (op == SinkMethodC__TOGGLE) 
                {
                  SinkMethodC__Leds__led2Toggle();
                }
              }
            }
        }
